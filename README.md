...
```console
$ docker exec -it caverage-events_backend_1 /bin/bash
```
...
The `.env` file is the one that contains all configurations, generated keys and passwords, etc.
...
Frontend: https://caverage.events

Backend: https://caverage.events/api/

Automatic Interactive Docs (Swagger UI): https://caverage.events/docs

Automatic Alternative Docs (ReDoc): https://caverage.events/redoc

PGAdmin: https://pgadmin.caverage.events

Flower: https://flower.caverage.events

### Staging URLs

Staging URLs, from the branch `master`.

Frontend: https://stag.caverage.events

Backend: https://stag.caverage.events/api/

Automatic Interactive Docs (Swagger UI): https://stag.caverage.events/docs

Automatic Alternative Docs (ReDoc): https://stag.caverage.events/redoc

PGAdmin: https://pgadmin.stag.caverage.events

Flower: https://flower.stag.caverage.events
...
This project was generated using https://github.com/tiangolo/full-stack-fastapi-postgresql
